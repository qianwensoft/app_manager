...
class WorkOrderListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = WorkOrderAdapter(workOrders) { wo: WorkOrder ->
        ...
        thread {
            try {
                ...
                val path = buildString {
                    append("/api/work-orders?limit=50")
    ...
    class WorkOrderAdapter(
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.tvElapsed.text = calculateElapsed(wo.createdAt, wo.closedAt, wo.status)
