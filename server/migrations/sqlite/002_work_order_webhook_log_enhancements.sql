...
ALTER TABLE work_order_webhook_logs ADD COLUMN resolved_json TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN request_url TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN request_method VARCHAR(10) DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN request_headers TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN request_body TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN response_headers TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN script_result TEXT DEFAULT '';
ALTER TABLE work_order_webhook_logs ADD COLUMN script_logs TEXT DEFAULT '';
